  ...
  return (
    <Fragment>
      ...
      <div className="container mx-auto py-24">
        ...
        <p className="mb-4">
          www.labcare.bio makes available the a Website Accessibility Widget
          that is powered by a dedicated accessibility server. The software
          allows www.labcare.bio to improve its compliance with the Web Content
        ...
        <p className="mb-4">
          The labcare.bio accessibility menu can be enabled either by hitting
          the tab key when the page first loads or by clicking the accessibility
        ...
        <p className="mb-4">
          LabCare continues its efforts to constantly improve the accessibility
          ...
          pages and content on www.labcare.bio fully accessible, some content
        ...
        <p className="mb-4">
          If you are experiencing difficulty with any content on www.labcare.bio
        ...
        <p className="mb-4">
          ...
          need assistance, please contact LabCare Customer Support as follows:
        </p>
        <a
