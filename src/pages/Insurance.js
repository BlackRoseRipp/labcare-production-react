    ...
    <Fragment>
      <section className="py-16 container mx-auto flex flex-col items-center">
        ...
        <p className="text-center mb-8">
          LabQ Diagnostics will bill the following insurance plans (patients
            ...
            <div className="flex flex-col">
              ...
              <div className="flex flex-col">
                ...
                <div className="flex my-2">
                  <BsCheck2 className="shrink-0 mr-2 mt-0.5" />
                  <p>
                    Blue Choice and Medi-Blue *LabQ Diagnostics, Inc. can't
      ...
      <section className="mt-5 mb-24">
        <div className="max-w-[800px] mx-auto">
          <p className="mb-4">
            ...
            <span className="font-bold">not reimburse</span> LabQ Diagnostics
            Inc.
            <br />
            <br />
            LabQ Diagnostics can provide laboratory services, however, the
